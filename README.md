...
- `HERON_MACRO_LIBRARY_DIR` sets the in-repo macro library directory (default: `<repo>/macro/library`).
...
```bash
export HERON_MACRO_LIBRARY_DIR=macro/library
export HERON_MACRO_PATH=macro/library/custom
