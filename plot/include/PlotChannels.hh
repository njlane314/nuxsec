  ...
  private:
    ...
    static const std::map<int, Properties> &mapping()
    {
        static const std::map<int, Properties> m = {
            ...
            {1, {1, "external", "Cosmic", colour_from_hex("#1f2a44"), 3345}},
            {2, {2, "out_fv", "Out FV", colour_from_hex("#ff9f1c"), 1001}},
            {10, {10, "numu_cc_np0pi", "#nu_{#mu}CC Np0#pi", colour_from_hex("#3a86ff"), 1001}},
            {11, {11, "numu_cc_0pnpi", "#nu_{#mu}CC 0p1#pi^{#pm}", colour_from_hex("#8338ec"), 1001}},
