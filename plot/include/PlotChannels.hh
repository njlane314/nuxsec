  ...
  private:
    static const std::map<int, Properties> &mapping()
    {
        static const std::map<int, Properties> m = {
            ...
            {1, {1, "external", "Cosmic", TColor::GetColor("#1f2a44"), 3345}},
            {2, {2, "out_fv", "Out FV", TColor::GetColor("#ff9f1c"), 1001}},
            {10, {10, "numu_cc_np0pi", "#nu_{#mu}CC Np0#pi", TColor::GetColor("#3a86ff"), 1001}},
            {11, {11, "numu_cc_0pnpi", "#nu_{#mu}CC 0p1#pi^{#pm}", TColor::GetColor("#8338ec"), 1001}},
            {12, {12, "numu_cc_pi0gg", "#nu_{#mu}CC #pi^{0}/#gamma#gamma", TColor::GetColor("#ff006e"), 1001}},
            {13, {13, "numu_cc_npnpi", "#nu_{#mu}CC multi-#pi^{#pm}", TColor::GetColor("#5e60ce"), 1001}},
            {14, {14, "nc", "#nu_{x}NC", TColor::GetColor("#4361ee"), 1001}},
            {15, {15, "signal_lambda_qe", "Signal #Lambda (QE-like)", TColor::GetColor("#39ff14"), 1001}},
            {16, {16, "signal_lambda_assoc", "Signal #Lambda + K assoc.", TColor::GetColor("#00e676"), 1001}},
            {17, {17, "nue_cc", "#nu_{e}CC", TColor::GetColor("#00f5d4"), 1001}},
            {18, {18, "numu_cc_other", "#nu_{#mu}CC Other", TColor::GetColor("#118ab2"), 1001}},
            {99, {99, "other", "Other", TColor::GetColor("#ff3d00"), 1001}}};
        return m;
    }
};
