...
//
// Run with:
//   ./nuxsec macro plotPREffVsLambdaKinematicsPostInclusiveMuCC.C
//   ./nuxsec macro plotPREffVsLambdaKinematicsPostInclusiveMuCC.C 'plotPREffVsLambdaKinematicsPostInclusiveMuCC("./scratch/out/event_list_myana.root")'
//   ./nuxsec macro plotPREffVsLambdaKinematicsPostInclusiveMuCC.C 'plotPREffVsLambdaKinematicsPostInclusiveMuCC("./scratch/out/event_list_myana.root","sel_triggered_muon && sel_reco_fv")'
//   ./nuxsec macro plotPREffVsLambdaKinematicsPostInclusiveMuCC.C 'plotPREffVsLambdaKinematicsPostInclusiveMuCC("./scratch/out/event_list_myana.root","sel_triggered_muon","pr_valid_assignment && pr_mu_completeness>0.2 && pr_mu_purity>0.7 && pr_p_completeness>0.2 && pr_p_purity>0.7 && pr_pi_completeness>0.2 && pr_pi_purity>0.7")'
                                    ...
                                    " && (pi_p>0.0)")
{
    ...
    if (use_imt)
    {
        ...
        std::cout << "[plotPREffVsLambdaKinematicsPostInclusiveMuCC] implicit MT enabled via NUXSEC_ENABLE_IMT\n";
    }
    else
    {
        ROOT::DisableImplicitMT();
        std::cout << "[plotPREffVsLambdaKinematicsPostInclusiveMuCC] implicit MT disabled (set NUXSEC_ENABLE_IMT=1 to enable)\n";
    }
